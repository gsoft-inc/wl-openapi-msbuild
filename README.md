...
- Validate OpenAPI spec with [Workleap Spectral rules](https://github.com/gsoft-inc/wl-api-guidelines/blob/main/.spectral.yaml)
...
- Users can select whether to validate the API with frontend or backend ruleset depending how they configure the `SpectralProfile` MSBuild property (`backend` (default) or `frontend`).
